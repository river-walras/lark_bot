"""Asynchronous FeishuBot implementation using httpx."""
...
class AsyncFeishuBot:
    ...
    async def _send_message(self, msg_data: Dict) -> ResponseResult:
        """
        发送消息的底层方法
    ...
    async def send_log_message(self, level: LogLevel, info: str) -> ResponseResult:
        """
        发送带有日志级别的富文本消息
        ...
        try:
            ...
            return await self._send_message(msg_data)
